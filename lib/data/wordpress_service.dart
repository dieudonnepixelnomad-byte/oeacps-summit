...
class WordpressService {
  ...
  Future<bool> sendAccreditationRequest({
    ...
    final url = Uri.parse(
      'https://summitoacps.com/wp-json/oeacp/v1/accreditation',
    );
    ...
    try {
      ...
      developer.log(
        'Sending accreditation request to $url',
      ...
      developer.log(
        'Accreditation response status: ${response.statusCode}',
        name: 'WordpressService',
      );
      developer.log(
        'Accreditation response body: ${response.body}',
        name: 'WordpressService',
      );
